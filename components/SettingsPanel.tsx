  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="mt-8 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        >
                            ...
                            <option value="gemini-3-pro-preview">Gemini 3 Pro Preview (Reasoning & Complex Tasks)</option>
                        </select>
                         <p className="text-xs text-gray-500 mt-1">Flash is faster; Pro is better for complex optimization.</p>
                    </div>
                     <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Temperature ({settings.temperature})</label>
                        <input 
                            type="range" 
                            min="0" 
                            max="1" 
                            ...
                            className="w-full h-2 bg-notion-border rounded-lg appearance-none cursor-pointer"
                        />
                         <p className="text-xs text-gray-500 mt-1">Lower for precision, higher for creativity.</p>
                    </div>
                </div>
            </div>
        </Card>
        ...
        <Card>
            <div className="p-6 space-y-4">
                <h4 className="font-semibold text-lg border-b border-notion-border pb-2">Evaluation Rubric</h4>
                <div>
                     <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Criteria List</label>
                     <Textarea 
                        value={settings.customEvaluationRubric}
                        onChange={(e) => updateSettings({ customEvaluationRubric: e.target.value })}
                        rows={3}
                        placeholder="e.g. Clarity, Specificity, Safety, ..."
                     />
                     <p className="text-xs text-gray-500 mt-1">Comma-separated list of criteria the Evaluator Agent will use to score prompts.</p>
                </div>
            </div>
        </Card>
